...
const addOne = (arr) => {
  let localArray = [];
  arr.forEach(element => localArray.push(element + 1));
  return localArray;
}
...
const allUpperCase = (arr) => {
  let thirdLocalArray = [];
  arr.forEach(element => thirdLocalArray.push(element.toUpperCase()))
  return thirdLocalArray;
};
...
const speaker = (words, callback) => {
  let fourthArry = []
  words.forEach(element => fourthArry.push(callback(element)))
  return fourthArry
};
...
const addNumbers = (num, arr, times, callback) => {
  callback(arr, num)
  arr.forEach( element => callback(times, element))
  return arr
};
