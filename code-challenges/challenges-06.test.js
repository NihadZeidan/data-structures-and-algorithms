...
const checkValues = (obj, value) => {
    ...
    return arrOfValues.includes(value);
};
...
const updateNumbers = (obj) => {
    ...
    allKeys.forEach(property => {
        let keysAndValues = `${property}: ${obj[property]}`
        arr.push(keysAndValues);
    })
...
const hasChildrenEntries = (arr, character) => {
    ...
    arr.forEach(element => {
        if (element.name === character) {
            ...
            toTest = Object.entries(element)[2][1].length
        }
    })
    return toTest
};
...
const totalCharacters = (arr) => {
    ...
    arr.forEach(element => {
        sum += 1
        sum += Object.values(element)[1] ? 1 : 0;
        sum += Object.values(element)[2].length
    })
    return sum
};
...
const houseSize = (arr) => {
    ...
    arr.forEach(obj => {
        sizes.push({
            house: Object.values(obj)[3],
            members: 1 + (Object.values(obj)[1] ? 1 : 0) + (Object.values(obj)[2].length)
        })
    })
...
const houseSurvivors = (arr) => {
    ...
    arr.forEach(obj => {
        survivors.push({
            house: Object.values(obj)[3],
            members: 1 + (Object.values(obj)[1] && !deceasedSpouses.includes(Object.values(obj)[1]) ? 1 : 0) + (Object.values(obj)[2].length)
        })
    })
